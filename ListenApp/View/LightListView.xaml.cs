...
namespace ListenApp.View
{
    ...
    /// </summary>
    public sealed partial class LightListView : Page
    {
        private NavigationHelper navigationHelper;

        private LightListViewModel defaultViewModel;

        public LightListViewModel DefaultViewModel
        {
        ...
        private async void CoreWindow_VisibilityChanged(Windows.UI.Core.CoreWindow sender, Windows.UI.Core.VisibilityChangedEventArgs args)
        {
            ...
            {
                await DefaultViewModel.LoadLights();
            }
        }
        ...
        {
            defaultViewModel = (LightListViewModel)this.DataContext;

            DefaultViewModel.SelectedLight = null;
        ...
        private void lightListBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
