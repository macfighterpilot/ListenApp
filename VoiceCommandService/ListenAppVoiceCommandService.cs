...
namespace ListenApp.VoiceCommands
{
    /// <summary>
    ...
    /// </summary>
    public sealed class ListenAppVoiceCommandService : IBackgroundTask
    {
        /// <summary>
    ...
    private async void LaunchAppInForeground()
        {
            var userMessage = new VoiceCommandUserMessage();
            userMessage.SpokenMessage = cortanaResourceMap.GetValue("LaunchingListenApp", cortanaContext).ValueAsString;
